...
# @BEGIN Python_add_dollarRate_nyc_chicken
...
# @OUT added_isnyc_currency_fields_menu
# @OUT added_ischicken_field_dish


# @BEGIN detect_dish_contains_chicken
...
# @END detect_dish_contains_chicken
...
# @OUT added_isnyc_fields_menu

# @END add_is_in_nyc_to_menu
...
# @BEGIN add_currency_exchange_to_menu

# @IN currency_exchange_rate
# @IN added_isnyc_fields_menu
...
# @OUT added_isnyc_currency_fields_menu
# @END add_currency_exchange_to_menu


# In[ ]:


# @END Python_add_dollarRate_nyc_chicken
